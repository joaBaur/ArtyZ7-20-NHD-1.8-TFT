...
#
# create_project.tcl: Tcl script for re-creating project 'NHD-1.8-TFT-ArtyZ7-20-HDMI-00'
#
# Generated by Vivado on Tue Jun 12 13:37:06 +0200 2018
...
#
#    "VideoProcessing.vhd"
#    "Driver_8bitParallel.vhd"
#    "NHD_18_128160EF_Init.vhd"
#    "NHD_18_128160EF.vhd"
#    "Main_wrapper.vhd"
#    "ArtyZ7_20Master.xdc"
#
...
set _xil_proj_name_ "ArtyZ7-20-NHD-1.8"
...
set orig_proj_dir "[file normalize "$origin_dir/NHD-1.8-TFT-ArtyZ7-20-HDMI-00"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/Driver_8bitParallel.vhd" ]\
 [file normalize "${origin_dir}/NHD_18_128160EF_Init.vhd" ]\
 [file normalize "${origin_dir}/NHD_18_128160EF.vhd" ]\
...
set file "Driver_8bitParallel.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "NHD_18_128160EF_Init.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
if { [get_files VideoProcessing.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Vivado2018_Projects/NHD-1.8-TFT-ArtyZ7-20-HDMI-00/NHD-1.8-TFT-ArtyZ7-20-HDMI-00.srcs/sources_1/imports/NHD_01/VideoProcessing.vhd
}
if { [get_files Driver_8bitParallel.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Vivado2018_Projects/NHD-1.8-TFT-ArtyZ7-20-HDMI-00/NHD-1.8-TFT-ArtyZ7-20-HDMI-00.srcs/sources_1/new/Driver_8bitParallel.vhd
}
if { [get_files NHD_18_128160EF_Init.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Vivado2018_Projects/NHD-1.8-TFT-ArtyZ7-20-HDMI-00/NHD-1.8-TFT-ArtyZ7-20-HDMI-00.srcs/sources_1/new/NHD_18_128160EF_Init.vhd
}
if { [get_files NHD_18_128160EF.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Vivado2018_Projects/NHD-1.8-TFT-ArtyZ7-20-HDMI-00/NHD-1.8-TFT-ArtyZ7-20-HDMI-00.srcs/sources_1/new/NHD_18_128160EF.vhd
}
...
# module references:
# NHD_18_128160EF, VideoProcessing
  ...
  set o_db [ create_bd_port -dir O -from 7 -to 0 o_db ]
  ...
  # Create instance: NHD_18_128160EF_0, and set properties
  set block_name NHD_18_128160EF
  set block_cell_name NHD_18_128160EF_0
  if { [catch {set NHD_18_128160EF_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $NHD_18_128160EF_0 eq "" } {
  ...
  connect_bd_net -net NHD_18_128160EF_0_bram_addrb [get_bd_pins NHD_18_128160EF_0/bram_addrb] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net NHD_18_128160EF_0_o_db [get_bd_ports o_db] [get_bd_pins NHD_18_128160EF_0/o_db]
  connect_bd_net -net NHD_18_128160EF_0_o_dc [get_bd_ports o_dc] [get_bd_pins NHD_18_128160EF_0/o_dc]
  connect_bd_net -net NHD_18_128160EF_0_o_rs [get_bd_ports o_rs] [get_bd_pins NHD_18_128160EF_0/o_rs]
  connect_bd_net -net NHD_18_128160EF_0_o_wr [get_bd_ports o_wr] [get_bd_pins NHD_18_128160EF_0/o_wr]
  ...
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins NHD_18_128160EF_0/bram_doutb] [get_bd_pins blk_mem_gen_0/doutb]
  ...
  connect_bd_net -net i_reset_1 [get_bd_ports i_reset] [get_bd_pins NHD_18_128160EF_0/i_reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins rgb2dvi_0/aRst]
  connect_bd_net -net i_resolution_0_1 [get_bd_ports i_resolution] [get_bd_pins VideoProcessing_0/i_resolution]
  connect_bd_net -net i_rgb_test_1 [get_bd_ports i_rgb_test] [get_bd_pins NHD_18_128160EF_0/i_rgb_test]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins NHD_18_128160EF_0/sys_clock] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/clk_in1]
